                ...
                <div class="col-xxl-4 col-lg-5">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                ...
                                <p class="text-muted mb-4">Ingrese su dirección de correo y le enviaremos un mensaje con instrucciones para restablecer su contraseña</p>
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-muted bg-body">Volver a <a href="auth-login.php" class="text-muted ms-1 link-offset-3 text-decoration-underline"><b>Iniciar Sesion</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
