                ...
                <div class="col-xxl-4 col-lg-5">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <h4 class="text-dark-50 text-center mt-0 fw-bold">Hasta luego</h4>
                                <p class="text-muted mb-4">Ahora has cerrado sesión correctamente.</p>
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-muted bg-body">Regresar a <a href="auth-login.php" class="text-muted ms-1 link-offset-3 text-decoration-underline"><b>Iniciar Sesion</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
